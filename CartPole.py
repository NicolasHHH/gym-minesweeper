...
# Our model will be a convolutional neural network that takes in the difference
...
# - plot_durations - a helper for plotting the durations of episodes, along with an
#                   average over the last 100 episodes (the measure used in the official evaluations).
